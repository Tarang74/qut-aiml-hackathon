...
const s = {
  ...
  topBar: {
    ...
    padding: "0.75rem 1rem", background: "#ffffff", borderBottom: "1px solid #ddd9d2",
    position: "sticky" as const, top: TICKER_HEIGHT, zIndex: 10, minWidth: 0, width: "100%",
  },
  roleTag: { fontSize: "0.6rem", background: "#e8f5f5", color: "#0d5858", padding: "0.15rem 0.4rem", borderRadius: 2, letterSpacing: "0.08em", marginRight: "0.4rem" },
  playerName: { fontSize: "0.85rem", color: "#4a4a44" },
  priceBlock: { textAlign: "center" as const },
  priceLabel: { display: "block", fontSize: "0.6rem", color: "#8a8a80", letterSpacing: "0.1em" },
  priceValue: { fontSize: "1.4rem", fontWeight: "bold" as const, color: "#1d6b1d" },
  phasePill: { fontSize: "0.8rem", fontWeight: "bold" as const, padding: "0.2rem 0.5rem", borderRadius: 4, letterSpacing: "0.04em" },
  cycleLabel: { fontSize: "0.65rem", color: "#9a9a90", marginTop: "0.15rem", textAlign: "right" as const },
  helpBtn: {
    flexShrink: 0, width: 28, height: 28, borderRadius: "50%",
    background: "#f0eee9", border: "1px solid #ddd9d2",
    color: "#5a5a54", fontSize: "0.85rem", fontWeight: "bold" as const,
    cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center",
    fontFamily: "inherit", padding: 0,
  },
  countdownBar: {
    display: "flex", flexDirection: "column" as const, alignItems: "center", justifyContent: "center",
    padding: "0.5rem 1rem", minHeight: 64, background: "#f0f8f0", borderBottom: "1px solid #c8e4c8",
  },
  countdownNum: { fontSize: "2rem", fontWeight: "700" as const, color: "#1d6b1d", lineHeight: 1 },
  countdownLabel: { fontSize: "0.65rem", color: "#5a9a5a", letterSpacing: "0.08em", textTransform: "uppercase" as const, marginTop: "0.1rem" },
  lockBar: {
    position: "sticky" as const, bottom: 0, display: "flex", gap: "0.5rem",
    padding: "0.75rem 1rem", background: "#ffffff", borderTop: "1px solid #ddd9d2", zIndex: 10,
  },
  lockBtn: {
    flex: 1, padding: "1rem 0.5rem", minHeight: 52, border: "1px solid", borderRadius: 8,
    fontFamily: "inherit", fontSize: "0.9rem", fontWeight: "600" as const,
    color: "#18181a", cursor: "pointer",
  },
  noActionBtn: { background: "#f0eee9", borderColor: "#c8c4be" },
  lockInBtn: { background: "#e8f5e8", borderColor: "#4a9a4a" },
  tabBar: {
    display: "flex", background: "#ffffff", borderBottom: "1px solid #e8e4df", width: "100%",
  },
  tabBtn: {
    flex: 1, padding: "0.75rem 0.25rem", minHeight: 44, background: "transparent",
    border: "none", borderBottom: "2px solid transparent", color: "#9a9a90",
    fontSize: "0.68rem", fontFamily: "inherit", cursor: "pointer", letterSpacing: "0.03em",
  ...
  content: { display: "flex", flexDirection: "column" as const, gap: "0.75rem", padding: "0.75rem", flex: 1, minWidth: 0, width: "100%" },
  card: { background: "#ffffff", border: "1px solid #ddd9d2", borderRadius: 8, padding: "0.9rem 1rem", minWidth: 0 },
  cardTitle: { margin: "0 0 0.6rem", fontSize: "0.7rem", color: "#8a8a80", textTransform: "uppercase" as const, letterSpacing: "0.08em" },
  statGrid: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.5rem 1rem" },
  stat: { display: "flex", flexDirection: "column" as const },
  statLabel: { fontSize: "0.65rem", color: "#9a9a90", textTransform: "uppercase" as const, letterSpacing: "0.06em" },
  statValue: { fontSize: "1rem", fontWeight: "500" as const, marginTop: "0.1rem" },
  btnGrid: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.5rem" },
  actionBtn: {
    border: "1px solid", borderRadius: 8, padding: "1rem 0.6rem", minHeight: 64,
    display: "flex", flexDirection: "column" as const, alignItems: "center",
    justifyContent: "center" as const, gap: "0.25rem", fontFamily: "inherit",
  },
  actionBtnLabel: { fontSize: "0.95rem", fontWeight: "600" as const, color: "#18181a" },
  actionBtnSub: { fontSize: "0.65rem", color: "#7a7a70" },
  qtyRow: { display: "flex", gap: "0.5rem" },
  qtyBtn: {
    flex: 1, padding: "0.6rem 0", background: "#f0eee9", border: "1px solid #ddd9d2",
    borderRadius: 6, color: "#7a7a70", fontSize: "1rem", fontFamily: "inherit", cursor: "pointer",
  },
  qtyBtnActive: { background: "#e8f5f5", borderColor: "#5a9a9a", color: "#0d5858" },
  targetRow: { display: "flex", gap: "0.5rem", alignItems: "center", minWidth: 0 },
  select: {
    flex: 1, minWidth: 0, background: "#f0eee9", border: "1px solid #ddd9d2", color: "#3a3a36",
    padding: "0.5rem 0.5rem", borderRadius: 4, fontFamily: "inherit", fontSize: "0.85rem",
  },
  optNote: { margin: "0 0 0.6rem", fontSize: "0.75rem", color: "#9a9a90", fontStyle: "italic" as const },
  empty: { color: "#8a8a80", textAlign: "center" as const, margin: 0 },
  feedbackCard: { background: "#edf8ed", border: "1px solid #9ac89a", borderRadius: 8, padding: "0.9rem 1rem" },
  feedbackHeader: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "0.5rem" },
  feedbackTitle: { fontSize: "0.7rem", color: "#1d6b1d", textTransform: "uppercase" as const, letterSpacing: "0.08em" },
  ...
  headlineCard: { background: "#ffffff", border: "1px solid #ddd9d2", borderRadius: 8, padding: "0.75rem 1rem" },
  ...
  modal: {
    background: "#ffffff", width: "100%", maxHeight: "80vh",
  ...
  modalHeader: {
    display: "flex", alignItems: "center", justifyContent: "space-between",
    padding: "1rem 1.25rem", borderBottom: "1px solid #e8e4df", flexShrink: 0,
  },
  modalTitle: { fontSize: "1rem", fontWeight: "700" as const, color: "#18181a", letterSpacing: "0.02em" },
  modalClose: {
    background: "transparent", border: "none", color: "#9a9a90",
    fontSize: "1.4rem", cursor: "pointer", padding: 0, lineHeight: 1,
  },
  modalBody: { overflowY: "auto" as const, padding: "1rem 1.25rem", display: "flex", flexDirection: "column" as const, gap: "1rem" },
  modalSection: { borderLeft: "3px solid #ddd9d2", paddingLeft: "0.75rem" },
  modalSectionTitle: { fontSize: "0.8rem", fontWeight: "700" as const, color: "#18181a", margin: "0 0 0.3rem", letterSpacing: "0.02em" },
  modalText: { fontSize: "0.82rem", color: "#5a5a54", lineHeight: 1.6, margin: 0 },
  queuedBanner: { background: "#edf8ed", border: "1px solid #9ac89a", borderRadius: 6, padding: "0.7rem 1rem", fontSize: "0.85rem", color: "#1d6b1d" },
  queuedNote: { color: "#9a9a90", fontSize: "0.75rem" },
} as const;
